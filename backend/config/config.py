...
PASSWORD_REQUIRE_LOWERCASE = os.getenv(
    "PASSWORD_REQUIRE_LOWERCASE", "true").lower() == "true"
PASSWORD_REQUIRE_NUMBERS = os.getenv(
    "PASSWORD_REQUIRE_NUMBERS", "true").lower() == "true"
PASSWORD_REQUIRE_SPECIAL = os.getenv(
    "PASSWORD_REQUIRE_SPECIAL", "true").lower() == "true"

# Rate Limiting
LOGIN_ATTEMPTS_LIMIT = int(os.getenv("LOGIN_ATTEMPTS_LIMIT", "5"))
LOGIN_ATTEMPTS_WINDOW_MINUTES = int(
    os.getenv("LOGIN_ATTEMPTS_WINDOW_MINUTES", "15"))
...
ENABLE_HISTOGRAM_ANALYSIS = os.getenv(
    "ENABLE_HISTOGRAM_ANALYSIS", "true").lower() == "true"
ENABLE_EOF_ANALYSIS = os.getenv(
    "ENABLE_EOF_ANALYSIS", "true").lower() == "true"

# CORS
ALLOWED_ORIGINS = os.getenv(
    "ALLOWED_ORIGINS", '["http://localhost:3000", "http://localhost:8080", "http://localhost:5173", "http://127.0.0.1:5173"]')
